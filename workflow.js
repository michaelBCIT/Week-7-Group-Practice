...
//page 5-2
document.querySelector(".SubHeaderPage5-2").innerHTML += SubHeaderUI("HOW DID THIS HAPPEN?", width = "340px", bubbleColor = "#FE9179", font="HOW DID THIS HAPPEN?", fontcolor="#FFFFFF;");
