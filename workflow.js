...
<<<<<<< HEAD
document.querySelector(".textbubblepage3-2").innerHTML += textBubbleLightUI("Large amounts of money are used to farm resources and crops. If thrown into the waste, all the money that went into those crops are wasted too.", "291px", "#FFFFFF");
=======
...
<<<<<<< HEAD
document.querySelector(".textbubblepage3-2--2").innerHTML += textBubbleLightUI("Large amounts of money are used to farm resources and crops. If thrown into the waste, all the money that went into those crops are wasted too.", "291px", "#FFFFFF");
=======
